...
public class CienteTeste2 {
    public static void main(String[] args) {
        ...
        ClienteClasse2 cliente2 = new ClienteClasse2("Manu", 35, TipoClienteEnum.PESSOA_FISICA);
        ClienteClasse2 cliente3 = new ClienteClasse2("Manu", 35, TipoClienteEnum.PESSOA_FISICA);
